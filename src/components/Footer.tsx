        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <span className="font-[family-name:var(--font-heading)] font-bold text-sm leading-tight block">Sumo Institute</span>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={link.to}>
                  <Link to={link.to} className="text-white hover:text-gold transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {["BSc Networking", "BSc Data Science", "BSc Cyber Security", "BSc Telecom Engineering", "BSc Project Management"].map((p) => (
                <li key={p}>
                  <Link to="/programs" className="text-white hover:text-gold transition-colors">
                    {p}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-secondary-foreground/10 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            {[
              ...
              <a key={social.label} href="#" aria-label={social.label} className="text-secondary-foreground/40 hover:text-gold transition-colors">
